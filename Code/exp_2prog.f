...
c        cycle time = dcymin
c--------------------------------------------------------------------------
      parameter (dlrmin=0.8d0,dlrmax=1.2d0,dcymin=0.8d0,dcymax=1.2d0,
     +     nstep=11)
c--------------------------------------------------------------------------
c
...
c---- enter loss/replacement dr values across timepoints
      dlrv(1)=0.21d0
      dlrv(2)=0.276d0*dlrval
      dlrv(3)=0.545d0*dlrval
      dlrv(4)=0.273d0*dlrval
      dlrv(5)=0.029d0*dlrval
      dlrv(6)=0.029d0*dlrval
      dcy(1)=dcy0*dcycle
      dcy(2)=dcy0*dcycle/1.9d0
      dcy(3)=dcy0*dcycle/2.6d0
      dcy(4)=dcy0*dcycle/2.3d0
      dcy(5)=dcy0*dcycle/1.8d0
      dcy(6)=dcy0*dcycle/1.3d0
